function calendar([day, month, year]) {
    let html = '<table>\n';
    html += '  <tr><th>Sun</th><th>Mon</th><th>Tue</th><th>Wed</th>' +
    ...
    for (let r = 0; r < 6; r++) {   // can't be more than 6 weeks
        if ((calendarDate.getMonth() !== inputDate.getMonth()) &&
            calendarDate.getTime() > inputDate.getTime()) {
            continue;
        }
        else {
            html += (r === 0) ? '  <tr>' : '<tr>';
        ...
        for (let c = 0; c < 7; c++) {
            ...
            else if ((calendarDate.valueOf() < inputDate.valueOf()) &&
                calendarDate.getMonth() !== inputDate.getMonth()) {
